...
######################################################################################
################ EXPECTED FINAL CLEAN DATA COLUMNS ###################################
######################################################################################
...
FILE_CONFIGS_WORKPAY_EQUITY= {"name": "workpay_equity", "prefix":"equity_payouts", "excel_rows":0, "csv_rows":0,
                              "sheet_name":"KES"}
EQUITY_COLUMNS = {"date":"Date", "date_column": "Transaction Date", "value_date": "Value Date", "details": "Narrative",
                  "reference": "Customer Reference", "debits": "Debit", "credits": "Credit", "remarks": "Remarks",
                  "session": "Session"}

NEW_EQUITY_COLUMNS = {"date_column": "Transaction Date", "value_date": "Value Date", "details": "Narrative",
                  "reference": "Customer Reference", "debits": "Debit", "credits": "Credit", "remarks": "Remarks",
                  "session": "Session"}

DEFAULT_EQUITY_BANK_FILE_COLUMNS = {"date_column": "Transaction Date", "value_date": "Value Date", "narrative": "Narrative",
                               "transaction_reference": "Transaction Reference", "customer_reference": "Customer Reference",
                               "debit": "Debit", "credit": "Credit", "balance": "Running Balance"}


######################################################################################
################ KCB FILE CONFIGURATIONS ###################################
######################################################################################
...
KCB_COLUMNS = {"date":"date", "date_column": "Transaction Date", "value_date": "Value Date", "details": "Transaction Details",
               "debits": "Money Out", "credits": "Money In", "balance": "Ledger Balance", "reference": "Bank Reference Number",
               "remarks": "Remarks", "session": "Session"}

######################################################################################
################ MPESA FILE CONFIGURATIONS ###################################
######################################################################################
...
MPESA_COLUMNS = {"date":"date", "reference": "Receipt No.", "value_date": "Completion Time", "date_column": "Initiation Time", "details": "Details",
